...
internal class WrapperItemKeyedDataSource<K : Any, A : Any, B : Any>(
    ...
    private val keyMapSynchronizedObject = SynchronizedObject()
    ...
    fun convertWithStashedKeys(source: List<A>): List<B> {
        ...
        synchronized(keyMapSynchronizedObject) {
    ...
    override fun getKey(item: B): K = synchronized(keyMapSynchronizedObject) {
        return keyMap[item]!!
    }
}
